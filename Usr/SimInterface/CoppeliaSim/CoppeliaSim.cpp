/**
  ...
  * <tr><td>2019-12-30   	<td> 1.0     <td>Mentos Seetoo    <td>Creator
	...
	if (clientID != -1)
	{
		...
		if (synchronous_mode)
		{
			if (multi_client_mode)
			{
				...
				if (simxGetIntegerSignal(clientID, iteration->siganl_name.data(), &iteration_temp, simx_opmode_streaming) == simx_return_ok)
